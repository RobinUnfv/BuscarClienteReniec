...
public class Empresa {
   ...
   public String toString() {
      return "Nombre = " + this.numeroDocumento + " - " + this.nombre + "\n estado=" + this.estado + "\n direccion=" + this.direccion + "\n distrito=" + this.distrito + "\n provincia=" + this.provincia + "\n departamento=" + this.departamento + "\n tipoDocumento=" + this.tipoDocumento + "\n numeroDocumento=" + this.numeroDocumento + "\n condicion=" + this.condicion + "\n ubigeo=" + this.ubigeo + "\n viaTipo=" + this.viaTipo + "\n viaNombre=" + this.viaNombre + "\n zonaCodigo=" + this.zonaCodigo + "\n zonaTipo=" + this.zonaTipo + "\n numero=" + this.numero + "\n interior=" + this.interior + "\n lote=" + this.lote + "\n dpto=" + this.dpto + "\n manzana=" + this.manzana + "\n kilometro=" + this.kilometro;
   }

   public boolean verificarEstado() {
      boolean e = false;
      if (this.getEstado().equals("BAJA DE OFICIO")) {
         e = true;
      }
   ...
   public Empresa(String nombre, String tipoDocumento, String numeroDocumento, String estado, String condicion, String direccion, String ubigeo, String viaTipo, String viaNombre, String zonaCodigo, String zonaTipo, String numero, String interior, String lote, String dpto, String manzana, String kilometro, String distrito, String provincia, String departamento) {
      this.nombre = nombre;
